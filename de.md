...
- Achtung: Der Schaden des Mönchs ist auf 15 begrenzt, so dass er den Raid Boss nicht sofort ausschalten kann. Mönch ist dennoch eine gute Option für Raids.
...
5. Ich empfehle, auf [Noff](https://noff.gg/clash-mini/decks) nach den besten Decks zu suchen, oder die YouTube-Kanäle der Clash Mini Creator zu besuchen, die Links findest du im Abschnitt "Content Creator" in diesem Guide.
...
- **Skelettkönig:** Haltet die Einheiten zusammen, damit keine Einheit isoliert wird, stellt Tanks an die Front, um eure Carries zu schützen, damit er nicht so leicht Kills bekommen kann.
...
- **Ritter:** Stellen Sie sicher, dass Sie Minis haben, die mehr als 1 Schaden verursachen. 
- **Speerkobold:** Stell deine Minis in einer Reihe auf und predicte deinen Gegner.
- **Magier:** Verteile deine Einheiten
- **Eismagier:** Versuchen Sie, ihn Ihre weniger wichtigen Minis, die keinen Schaden anrichten sollen, angreifen zu lassen, z.B. das Riesenskelett
- **Swordsman:** Lassen Sie keine Einheiten ohne Verbündete in der Nähe, da diese einen leichten Kill darstellen und sogar die Super des Swordsman aufladen können
- **Skeleton Guard:** Konzentriert euch nicht auf ihn, er wird euren Einheiten nicht viel antun
- **Barbar:** Versuche, ihn in den ersten 10 Sekunden auszuschalten, da er schneller angreift, je länger er auf dem Feld ist
- **Musketierin:** Versammle deine Einheiten, damit keine Einheit zurückgeworfen wird, weil der Weg durch deine anderen Einheiten versperrt ist.
...
- **Goldener Riese:** Betäuben Sie ihn nicht.
...
- **Elektro-Magier:** Versuchen Sie, mehr Einheiten vor Ihren Carrys auf das Spielfeld zu bringen, versuchen Sie, ihn mit Clash-Fähigkeiten auszuschalten oder benutzen Sie die Hexe, benutzen Sie War Toot.
...
- **Pancaker:** Verbessern Sie die Anti-Heal-Fähigkeiten oder setzen Sie CLASH-Fähigkeitseinheiten auf den Bahnen ein, auf denen die gegnerischen Truppen geheilt werden würden, z. B. Pancaker auf der rechten Seite -> CLASH-Einheiten auf der linken Seite. Das ist hilfreich, weil der Pancaker den am weitesten entfernten Verbündeten angreift.
...
- **War Toot:** Rüste keine Minis mit Kontrolleffekten auf, da sie sonst nutzlos sind.
